...
petting-success-meatcutie = You pet {THE($target)} on {POSS-ADJ($target)} wet little head. {CAPITALIZE(OBJECT($target))} seems to like it!
...
petting-failure-Meatcutie = You try to pet {THE($target)} on {POSS-ADJ($target)} wet little head, It trys to bite at you!
